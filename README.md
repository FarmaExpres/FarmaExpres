...
**Última actualización:** 2026-04-02 11:25 UTC
...
|---|---:|---:|---:|---:|
| José Leonardo Vargas | 8 | 100.00% | 1 | 1 |

### Gráfico de torta

```mermaid
%%{init: {"themeVariables": {"pie1": "#ff6f61", "pieLabelColor": "#000000", "pieLabelFontSize": "24px", "pieLabelFontWeight": "700"}}}%%
pie showData
    title Participación del grupo de trabajo
    "José Leonardo Vargas" : 8
```
...
xychart-beta
    title "Participación del grupo de trabajo"
    x-axis ["José Leonardo Vargas"]
    y-axis "Commits únicos" 0 --> 8
    bar [8]
```
<!-- KPI:END -->
